...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GM] = LAYOUT(
        KC_ESC ,KC_1   ,KC_2   ,KC_3   ,KC_4   ,KC_5   ,                KC_6   ,KC_7   ,KC_8   ,KC_9   ,KC_0   ,TG(_GM),
        ...
        KC_LSFT,KC_Z   ,KC_X   ,KC_C   ,KC_V   ,KC_B   ,                XXXXXXX,KC_BTN6,KC_BTN7,KC_BTN8,XXXXXXX,XXXXXXX,
                                _______,_______,_______,_______,KC_BTN4,KC_BTN1,KC_BTN3,KC_BTN2,
                            _______,                    _______,KC_BTN5,                    XXXXXXX
    ),
    [_NP] = LAYOUT(
        _______,_______,_______,_______,_______,_______,                _______,_______,_______,_______,_______,_______,
        KC_TAB ,KC_PSLS,KC_7   ,KC_8   ,KC_9   ,KC_PMNS,                KC_PSLS,KC_7   ,KC_8   ,KC_9   ,KC_PMNS,_______,
        KC_CALC,KC_PAST,KC_4   ,KC_5   ,KC_6   ,KC_PPLS,                KC_PAST,KC_4   ,KC_5   ,KC_6   ,KC_PPLS,KC_CALC,
        KC_LSFT,KC_PERC,KC_1   ,KC_2   ,KC_3   ,KC_EQL ,                KC_PERC,KC_1   ,KC_2   ,KC_3   ,KC_EQL ,_______,
    ...
    [_FN] = LAYOUT(
        ...
        KC_LSFT,KC_PERC,KC_1   ,KC_2   ,KC_3   ,KC_EQL ,                KC_MPRV,KC_MPLY,KC_MNXT,KC_MUTE,KC_VOLD,KC_VOLU,

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LSFT,KC_Z   ,KC_X   ,KC_C   ,KC_V   ,KC_B   ,                KC_N   ,KC_M   ,KC_COMM,KC_DOT ,KC_SLSH,KC_QUES,
                            KC_LALT,KC_LWIN,KC_LSFT,KC_LCTL,CTL_ENT,SFT_SPC,LT_INS ,KC_DEL ,
                            TG(_FN),                XXXXXXX,XXXXXXX,                XXXXXXX
    ),
    [_FN] = LAYOUT(
    ...
    _______,KC_PERC,KC_1   ,KC_2   ,KC_3   ,KC_DLR ,                XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,
                            KC_EQL ,KC_DOT ,KC_0   ,KC_PENT,KC_RCTL,KC_RSFT,TG(_FN),KC_RALT,
                            TG(_FN),                XXXXXXX,XXXXXXX,                XXXXXXX
    )
};
